...
st.set_page_config(
    page_title="Site Scraper AI",
    page_icon="🌐",
)


def data_ingestion():
    loader=TextLoader("crawler_output.txt", encoding="utf-8")
...
def clear_chat_history():
    st.session_state.messages = [
        {"role": "assistant", "content": "Ask me questions on the website https://www2.deloitte.com/us/en/insights/economy/asia-pacific/india-economic-outlook.html"}]
